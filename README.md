...
* Vote on their favorite pitch  by giving it a upvote or a downvote.
* Register and be allowed to log in to the application
...
1. Cloning the repository:
  ```bash
  https://github.com/VonettaOrinda/pitch_perfect
  ```
